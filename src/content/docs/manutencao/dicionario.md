...
| `sortField`         | `Query Parameter`                 | [Consulta](/api-guidelines/execucao/consultas), [Paginação](/api-guidelines/execucao/paginacao) |
| `sortDirection`     | `Query Parameter`                 | [Consulta](/api-guidelines/execucao/consultas), [Paginação](/api-guidelines/execucao/paginacao) |
